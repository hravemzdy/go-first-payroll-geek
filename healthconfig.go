...
const (
	...
	HEALTH_PROP_2013_BASIS_MONTHLY_MINIMUM_UPTO_07 int32   = HEALTH_PROP_2012_BASIS_MONTHLY_MINIMUM
...
func NewHealthGuides(period Period, basisMonthlyMinimum int32, basisAnnualMaximum int32,
	factorCompound float32, incomeEmployMargin int64, incomeAgreemMargin int64) HealthGuides {
	return HealthGuides{
		InternalPeriod:      period,
